declare namespace zip {
   ...
   */
  export class TransformStreamLike {
    /**
     * The readable stream.
     */
   ...
   */
  export class ZipDeflate extends SyncCodec {
    /**
     * Flushes the data
     *
     * @returns A chunk of compressed data.
   ...
   */
  export class ZipInflate extends SyncCodec {
    /**
     * Flushes the data
     */
    flush(): void;
   ...
   */
  export class CodecStream extends TransformStream {}
