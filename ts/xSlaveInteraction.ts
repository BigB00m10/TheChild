  ...
  options: {
    talk: {
      ...
      next: {
        ...
        sexExp: {
          ...
          $npc.GenPronoun smile<<thirdPersonVerb>> and look<<thirdPersonVerb>> proud about it.
    ...
    pushDown: {
      ...
      contents: `You push $npc.name down, placing your body over $npc.pronoun.
        <<if $npc.fear gt 25>>\
          $npc.GenPronoun tremble<<thirdPersonVerb>> in fear under your shadow.
        <<elseif $npc.love gt 50>>\
          $npc.GenPronoun leave<<thirdPersonVerb>> <<- $npc.pronoun>>self completely open as $npc.genPronoun smile<<thirdPersonVerb>> at you<<emoji ♥>>.
        <</if>>`,
...
/*            */<<elseif $npc.hasPenis>>\
/*              */@@color:deeppink;$npc.genPronoun <<npcVerbIs>> hard@@\
/*            */<</if>> !!<<emoji 👀>>
              <<else>>\
                You admire $npc.possessive nice body. <<emoji 👀>>
              <</if>>\
              <<if $npc.love gt 50>>$npc.GenPronoun offer<<thirdPersonVerb>> no resistance<<emoji ♥>> and let<<thirdPersonVerb>> you have your way.<</if>>`,
          next: {
            fingerAss: {
            ...
            fingerPussy: {
              ...
              contents: `<<if $npc.pussyTraining lt 20>>\
                ...
                <<else>>\
                  ...
                  <<if $npc.lust gte 60>>\
                    ...
                    $npc.GenPronoun <<npcVerbIs>> breathing hard. Looks like $npc.name is really enjoying this.\
                  <</if>>\
                <</if>><<npcStimulated>>`,
              ...
              next: {
                cum: {
                  ...
                  It doesn't take long until $npc.genPronoun cum<<thirdPersonVerb>> making your hand wet all over.<<npcCum>>`,
              ...
              next: {
                penPussy: {
                  ...
                  <<if $npc.age gt 3 && ($npc.lust lt 30 || $npc.fear gte 40)>>\
                    $npc.GenPronoun panic<<thirdPersonVerb>> <<emoji 😨>> as $npc.genPronoun see<<thirdPersonVerb>> your dick pressing against $npc.possessive private place.
                  <</if>>\
                  <<if $npc.aroused>>\
              ...
              next: {
                carefully: {
                  ...
                  contents: `<<if $npc.pussyTraining lt 20>>\
                    ...
                    <<elseif $npc.pussyTraining lt 60>>\
                      ...
                      <<if $npc.aroused || $npc.lubricatedPussy>>\
                        $npc.GenPronoun look<<thirdPersonVerb>> a little troubled<<emoji 😣>>, but it looks like $npc.genPronoun can take it.
                      <<else>>\
                    ...
                    <<elseif $npc.pussyTraining lt 80>>\
                      <<set _cockEntered to true>>\
                      <<if $npc.aroused || $npc.lubricatedPussy>>\
                        Your cock easily slides inside $npc.pronoun. $npc.GenPronoun do<<thirdPersonVerbPlural>>n't seem to hate it.
                      <<else>>\
                        $npc.GenPronoun squint<<thirdPersonVerb>> $npc.possessive eyes as you penetrate $npc.pronoun. <<emoji 😣>>
                        $npc.Possessive dry pussy hurts a little.
                      <</if>>\
                    <<else>>\
                      <<set _cockEntered to true>>\
                      Your cock slides right in as $npc.genPronoun let<<thirdPersonVerb>> out a quiet ~~"Ah!"~~.<<npcStimulated>>
                    <</if>>\
                    <<if _cockEntered>>\
                ...
                ram: {
                  ...
                  contents: `<<if $npc.pussyTraining lt 80>>\
                      ...
                      $npc.GenPronoun start<<thirdPersonVerb>> crying and whimpering.
                    <<else>>\
                      You slam the whole thing inside filling up $npc.possessive vagina.
                      $npc.GenPronoun look<<thirdPersonVerb>> surprised<<emoji 😲>> with $npc.possessive $npc.eyeColor eyes wide open.
                  ...
                  next: {
                    slow: {
                      ...
                      contents: `You try your best in slowly going in and out of $npc.name's $npc.age year old $npc.genitals.female.
                        <<if $npc.pussyTraining lt 20>>\
                          $npc.GenPronoun keep<<thirdPersonVerb>> crying<<if $npc.age gt 0>> and pushing you while saying "Stop! It hurts!!"<</if>>. <<emoji 😢>>
                        <<elseif $npc.pussyTraining lt 40>>\
                        ...
                        <<elseif $npc.lust lt 30>>\
                          $npc.GenPronoun seem<<thirdPersonVerb>> to be able to take you in and, after a while, it even starts to feel good for $npc.pronoun.\
                          <<if $npc.love gte 75>>$npc.GenPronoun smile<<thirdPersonVerb>> at you as you make love to $npc.pronoun. <<emoji ♥>><</if>><<npcStimulated>>
                        <<else>>\
                    ...
                    fast: {
                      ...
                      <<if $npc.pussyTraining lt 40>>\
                        $npc.GenPronoun <<if $npc.age gt 0>>push<<thirdPersonVerbPlural>> you while crying<<else>>cries<</if>> desperately. <<emoji 😭>>
                      <<elseif $npc.pussyTraining lt 60>>\
                      ...
                      <<elseif $npc.lust lt 60>>\
                        $npc.GenPronoun seem<<thirdPersonVerb>> to be able to withstand your piston and, after a while, it even starts to feel good for $npc.pronoun.\
                        <<if $npc.love gte 75>>$npc.GenPronoun smile<<thirdPersonVerb>> at you as you screw $npc.pronoun.<<emoji ♥>><</if>>
                      <<else>>\
                ...
                ram: {
                  ...
                  next: {
                    slow: {
                      ...
                      contents: `You try your best in slowly going in and out of $npc.name's $npc.age year old rectum.
                        ...
                        <<elseif $npc.anusTraining lt 40>>\
                          $npc.name seems to have a hard time taking your dick while squinting $npc.possessive eyes<<emoji 😣>> while you fuck $npc.pronoun.
                        <<elseif $npc.lust lt 30>>\
                          $npc.GenPronoun seem<<thirdPersonVerb>> to be able to take you in and, after a while, even starts to feel good for $npc.pronoun.\
                          <<if $npc.love gte 75>>$npc.GenPronoun smile<<thirdPersonVerb>> at you as you make love to $npc.pronoun. <<emoji ♥>><</if>><<npcStimulated>>
                        <<else>>\
                          $npc.name is visibly enjoying your cock. You can hear $npc.pronoun loudly moaning:<<npcStimulated>>
                          "Ah!...Ah!...<<if $npc.age gt 4>> Yes... Please don't stop!!<</if>>\
                    ...
                    fast: {
                      ...
                      <<elseif $npc.lust lt 60>>\
                        $npc.GenPronoun seem<<thirdPersonVerb>> to be able to withstand your piston and, after a while, it even starts to feel good for $npc.pronoun.\
                        <<if $npc.love gte 75>>$npc.GenPronoun smile<<thirdPersonVerb>> at you as you screw $npc.pronoun.<<emoji ♥>><</if>><<npcStimulated>>
                      <<else>>\
                        $npc.name keeps turning $npc.possessive head from side to side due to the immense pleasure <<genPronounIs>> experiencing.<<npcStimulated>>
                        "Ah!, Ah!, Ah!<<if $npc.age gt 3 && $npc.love gte 50>>, <<npcAddressPlayer>>!...<<emoji 💕>><</if>>"<<emoji 😫>>\
                      <</if>>`,
              ...
              next: {
                dildoVag: {
                  ...
                  contents: `You push the dildo against $npc.possessive $npc.genitals.female.
                    <<if $npc.age gt 3 && ($npc.lust lt 30 || $npc.fear gte 40)>>\
                      $npc.GenPronoun panic<<thirdPersonVerb>> <<emoji 😨>> as $npc.genPronoun see<<thirdPersonVerb>> the dildo pressing against $npc.possessive private place.
                    <</if>>\
                    <<if $npc.aroused>>\
                    ...
                    carefully: {
                      ...
                      contents: `<<if $npc.pussyTraining lt 20>>\
                        ...
                        <<elseif $npc.pussyTraining lt 80>>\
                          <<set _cockEntered to true>>\
                          <<if $npc.aroused || $npc.lubricatedPussy>>\
                            The dildo easily slides inside $npc.pronoun. $npc.GenPronoun do<<thirdPersonVerbPlural>>n't seem to hate it.
                          <<else>>\
                            $npc.GenPronoun squint<<thirdPersonVerb>> $npc.possessive eyes as you penetrate $npc.pronoun.<<emoji 😣>>
                            $npc.Possessive dry pussy hurts a little.
                          <</if>>\
                        <<else>>\
                          <<set _cockEntered to true>>\
                          The dildo slides right in as $npc.genPronoun let<<thirdPersonVerb>> out a quiet ~~"Ah!"~~.<<npcStimulated>>
                        <</if>>\
                        <<if _cockEntered>>\
                          <<checkNpcVirgin vagina>>\
                        <</if>>`,
                    ...
                    ram: {
                      ...
                      next: {
                        slow: {
                          ...
                          contents: `You try your best in slowly going in and out of $npc.name's $npc.age year old $npc.genitals.female.
                            <<if $npc.pussyTraining lt 20>>\
                              $npc.GenPronoun keep<<thirdPersonVerb>> crying<<if $npc.age gt 0>> and pushing your hand while saying "Stop! It hurts!!"<</if>>. <<emoji 😢>>
                            <<elseif $npc.pussyTraining lt 40>>\
                              $npc.name seems to have a hard time taking the dildo while squinting $npc.possessive eyes<<emoji 😣>> while you fuck $npc.pronoun.
                            <<elseif $npc.lust lt 30>>\
                              $npc.GenPronoun seem<<thirdPersonVerb>> to be able to take the dildo in and, after a while, it even starts to feel good for $npc.pronoun.\
                              <<if $npc.love gte 75>>$npc.GenPronoun smile<<thirdPersonVerb>> at you as you fuck $npc.pronoun with your dildo. <<emoji ♥>><</if>>
                            <<else>>\
                        ...
                        fast: {
                          ...
                          <<elseif $npc.lust lt 60>>\
                            $npc.GenPronoun seem<<thirdPersonVerb>> to be able to withstand your piston and, after a while, it even starts to feel good for $npc.pronoun.\
                            <<if $npc.love gte 75>>$npc.GenPronoun smile<<thirdPersonVerb>> at you as you play with $npc.pronoun.<<emoji ♥>><</if>>
                          <<else>>\
                            $npc.name keeps turning $npc.possessive head from side to side due to the immense pleasure <<genPronounIs>> experiencing.<<npcStimulated>>
                            "Ah!, Ah!, Ah!<<if $npc.age gt 3 && $npc.love gte 50>>, <<npcAddressPlayer>>!...<<emoji 💕>><</if>>"<<emoji 😫>>\
                          <</if>>`,
                    ...
                    ram: {
                      ...
                      next: {
                        slow: {
                          ...
                          contents: `You try your best in slowly going in and out of $npc.name's $npc.age year old rectum.
                            ...
                            <<elseif $npc.anusTraining lt 40>>\
                              $npc.name seems to have a hard time taking the dildo while squinting $npc.possessive eyes<<emoji 😣>> while you fuck $npc.pronoun.
                            <<elseif $npc.lust lt 30>>\
                              $npc.GenPronoun seem<<thirdPersonVerb>> to be able to take it in and, after a while, it even starts to feel good for $npc.pronoun.\
                              <<if $npc.love gte 75>>$npc.GenPronoun smile<<thirdPersonVerb>> at you as you move the dildo in and out of $npc.possessive ass.<<emoji ♥>><</if>><<npcStimulated>>
                            <<else>>\
                        ...
                        fast: {
                          ...
                          <<run Player.manageEnergy(1)>>\
                          <<if $npc.anusTraining lt 40>>\
                            $npc.GenPronoun <<if $npc.age gt 0>>push<<thirdPersonVerbPlural>> your hand while crying<<else>>cries<</if>> desperately. <<emoji 😭>>
                          <<elseif $npc.anusTraining lt 60>>\
...
/*                            */@@color:deeppink;$npc.GenPronoun get<<thirdPersonVerb>> harder@@\
                            <</if>>\
                            <<if $npc.anusTraining lt 20>>\
                              despite the pain in $npc.possessive bottom.  $npc.GenPronoun keep<<thirdPersonVerb>> crying the pleasure and pain is tormenting $npc.pronoun.<<emoji 😢>>
                            <<elseif $npc.anusTraining lt 40>>\
                              even though $npc.name seems to have a hard time taking the dildo.
                            <<elseif $npc.lust lt 30>>\
                              and $npc.possessive body even starts to enjoy the feel of the dildo in $npc.possessive bottom.  $npc.GenPronoun <<npcVerbIs>> very confused and conflicted by the mix of feelings. \
                              <<if $npc.love gte 75>>$npc.GenPronoun smile<<thirdPersonVerb>> at you as you move the dildo in and out of $npc.possessive ass.<<emoji ♥>><</if>><<npcStimulated>>
                            <<else>>\
            ...
            rubPussies: {
              ...
              contents: `You open $npc.possessive legs and you start rubbing your pussy against <<if $npc.gender != 'boy'>>hers<<else>>his<</if>>.
                ...
                <<elseif $npc.lust lt 65>>\
                  $npc.name doesn't resist at all. $npc.GenPronoun let<<thirdPersonVerb>> you have your way and seem<<thirdPersonVerb>> to enjoy it while closing $npc.possessive eyes. <<emoji 😩>>
                  <<if $npc.love gte 50>>$npc.GenPronoun smile<<thirdPersonVerb>> at you as you make love to $npc.pronoun. <<emoji ♥>><</if>>
                <<else>>\
                  $npc.name starts moaning along. "Ah!...Ah!..." <<emoji 😩>>
                  <<if $npc.love gt 50>>
                    $npc.genPronoun smile<<thirdPersonVerb>> at you and say<<thirdPersonVerb>>: "I love you <<npcAddressPlayer>>!!<<emoji ♥>>"
                  <</if>>
                <</if>><<npcStimulated>>`,
              npcStats: (npc) => {
            ...
            gentleRubSlaveGen: {
              ...
              contents: `You slowly rub $npc.name's $npc.genitals.all.
                After a while, \
                <<if $npc.hasPussy && $npc.hasPenis>>\
                  @@color:deeppink;$npc.possessive cunny gets wet and $npc.genPronoun get<<thirdPersonVerb>> hard@@.
                <<elseif $npc.hasPussy>>\
                  @@color:deeppink;$npc.possessive cunny gets wet@@.
                <<elseif $npc.hasPenis>>\
                  @@color:deeppink;$npc.genPronoun get<<thirdPersonVerb>> hard@@.
                <</if>><<npcStimulated>>`,
    ...
    askLickPus: {
      ...
      <<if $npc.love gte 80>>\
        ...
        Right after finishing $npc.possessive sentence, $npc.name places $npc.possessive<<if $npc.age lt 7>> little<</if>> hands on your legs as $npc.genPronoun approach<<thirdPersonVerbPlural>> $npc.possessive face to your pussy.
        ...
        <<if $npc.mouthTraining gte 30>>\
          $npc.name already knows how to pleasure you and focuses on your clit, giving you lots of pleasure. You instinctively press $npc.possessive head towards you while $npc.genPronoun insist<<thirdPersonVerb>> on the licking and sucking.
        <<else>>\
          $npc.name randomly licks you between your legs. <<genPronounIs>> a little clumsy with it but <<genPronounIs>> trying $npc.possessive best and it feels pretty good.
        <</if>>\
      <<elseif $npc.lust gte 60>>\
        Hearing that makes $npc.pronoun aroused and $npc.genPronoun blush<<thirdPersonVerbPlural>> at the thought.<<npcStimulated>>
      ...
      <<else>>\
        ...
        <<elseif $npc.mouthTraining lt 60>>\
          ...
          $npc.GenPronoun give<<thirdPersonVerb>><<else>>$npc.name gives<</if>> you random licks to your labia, some of them end up rubbing your clit giving you some little peaks of pleasure.
          <<genPronounIs>> not too shabby, although $npc.genPronoun do<<thirdPersonVerbPlural>>n't put too much passion into it and seems like <<genPronounIs>> doing some chore. But feels pretty good for you anyway.
        <<else>>\
          $npc.name's no amateur about this, $npc.genPronoun already know<<thirdPersonVerb>> how to please you.
          $npc.GenPronoun start<<thirdPersonVerb>> by sinking $npc.possessive tongue under your labia and lick inside. You feel $npc.possessive<<if $npc.age lt 7>> little<</if>> warm lips over your labia while $npc.genPronoun do<<thirdPersonVerbPlural>> it.
      ...
      next() {
        ...
        return {
          ...
          more: {
            ...
            $npc.name obeys and keeps licking you making lots of lewd noises. $npc.Possessive face gets covered by your juices more and more as $npc.genPronoun keep<<thirdPersonVerb>> licking.`,
            npcStats(npc) {
              let stats = ["mouthTraining+10", "fear-5", "hunger-1"];
    ...
    penToMouth: {
      ...
      <<else>>\
        ...
        <<else>>\
          $npc.name <<if $npc.hunger gt 80>>is so hungry that $npc.genPronoun do<<thirdPersonVerbPlural>><<else>>does<</if>> not hesitate and open<<thirdPersonVerb>> $npc.possessive mouth allowing you to enter.
          You can feel the warmth inside $npc.possessive mouth wrapping around your dick and $npc.possessive lips closing on it.
          $npc.GenPronoun start<<thirdPersonVerb>> suckling on your member and rubbing with $npc.possessive tongue while inside $npc.possessive mouth, <<if $npc.hunger gt 80>>desperate to get whatever sustenance $npc.genPronoun can get, <</if>>making a lot of noise.\
          <<set _sucking = true>>\
        <</if>>\
      ...
      next() {
        ...
        return {
          balls: {
            ...
            $npc.GenPronoun move<<thirdPersonVerb>> $npc.possessive mouth down to them and start<<thirdPersonVerb>> licking.
            Your balls bounce a little bit with $npc.possessive<<if $npc.age lt 7>> little<</if>> tongue.
            <<if $npc.mouthTraining gte 60>>\
              $npc.GenPronoun then lick<<thirdPersonVerb>> all around them while giving you gentle sucks on each ball.\
            <</if>>`,
          ...
          shaft: {
           ...
           <<if $npc.mouthTraining gte 60>>\
             Then $npc.genPronoun slowly slide<<thirdPersonVerb>> $npc.possessive tongue from head to base using your cock's entire length.
          ...
          deep: {
            ...
            <<if _refused>>\
              ...
              <<if !_okBj>>\
                ...
                <<else>>\
                  It seems that $npc.genPronoun do<<thirdPersonVerbPlural>>n't want to continue sucking you.\
                <</if>>\
              <</if>>\
            <<else>>\
              <<if $npc.hunger gt 80>>\
                $npc.name is so hungry that $npc.genPronoun allow<<thirdPersonVerb>> you to \
              <<elseif $npc.fear gt 80>>\
                $npc.name is so scared of you that $npc.genPronoun do<<thirdPersonVerbPlural>>n't fight as you\
              <<else>>\
                $npc.name looks surprised but allows you to \
              <</if>>\
              penetrate $npc.possessive throat.
              $npc.GenPronoun suck<<thirdPersonVerb>> your cock while its filling all of the space inside $npc.possessive mouth.
              ...
              <<elseif $npc.fear gte 80>>\
                $npc.GenPronoun <<npcVerbIs>> terrified of you, but it doesn't take long until $npc.genPronoun has to retreat for air.  Fear that you will hurt $npc.pronoun makes $npc.pronoun gobble your dick up again and again.\
                <<set _sucking = true>>\
              <<else>>\
          ...
          suck: {
            ...
            <<if $npc.mouthTraining gte 50>>\
              $npc.GenPronoun then start<<thirdPersonVerb>> sucking and jerking while your dick goes in and out of $npc.possessive mouth.
            ...
            <<if $npc.hunger gte 80>>\
              $npc.GenPronoun look<<thirdPersonVerb>> up at you, so hungry that $npc.genPronoun suck<<thirdPersonVerb>> desperately on your cock.\
            <</if>>\
            `,
          ...
          cumInside: {
            ...
            <<if $npc.hunger gte 50 || $npc.lust gte 80>>\
              $npc.GenPronoun gulp<<thirdPersonVerb>> all of your load directly after each spurt.
            <<else>>\
              $npc.GenPronoun does not seem to appreciate your sperm very much and quickly retreat<<thirdPersonVerb>> while coughing and spitting.
            <</if>>`,
            npcStats: (npc) =>
    ...
    rubPenToSlaveFace: {
      ...
      contents: `You grab $npc.name's head and press it between your legs and start rubbing.
        ...
        $npc.GenPronoun look<<thirdPersonVerb>> at you with some precum on $npc.possessive face. <<emoji 🥺>>
    ...
    rubVagToSlaveFace: {
      ...
      contents: `You grab $npc.name's head and press it between your legs and start rubbing.
        ...
        $npc.GenPronoun look<<thirdPersonVerb>> at you with $npc.possessive now wet face. <<emoji 🥺>>
