        ...
        sexExp: {
          ...
          contents: `<<set
            ...
            if(Person.hasAchievement('playerNoticedPreviousOralTraining'))
              _obs.push($player.genitals != 'dick' ? "you were so good licking my pussy" : "you sucked my dick so well");
      ...
      next: {
        strip: {
          ...
          next: {
            ...
            gentleRubSlaveGen: {
              optionText: "👋 Gently rub $npc.name's $npc.genitals.female.",
              minutesCost: 5,
              contents: `You slowly rub $npc.name's $npc.genitals.female.
                After a while, \
